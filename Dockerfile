...
RUN dpkg -i ./jdk-26_linux-x64_bin.deb
RUN rm -f jdk-26_linux-x64_bin.deb
RUN ls -l /usr/lib/jvm
RUN update-alternatives --install /usr/bin/java java /usr/lib/jvm/jdk-26.0.1-oracle-x64/bin/java 2626
